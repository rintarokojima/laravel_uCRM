                                ...
                                <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                                    <table class="table-auto w-full text-left whitespace-no-wrap">
                                        ...
                                        <tr v-for="order in props.orders.data" :key="order.id">
                                            ...
                                            <td class="border-t-2 px-4 py-3">{{ order.customer_name }}</td>
                                            <td class="border-t-2 px-4 py-3">{{ order.total }}</td>
                                            <td class="border-t-2 px-4 py-3">{{ order.status }}</td>
                                            <td class="border-t-2 px-4 py-3">{{ dayjs(order.created_at).format('YYYY-MM-DD HH:mm:ss') }}</td>   
