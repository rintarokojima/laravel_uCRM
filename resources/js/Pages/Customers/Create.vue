            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <BreeazeValidationErrors :errors="errors"/>
                            ...
                            <form @submit.prevent="storeCustomer">
                                <div class="container px-5  mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                        <div class="relative">
                                            <label for="kana" class="leading-7 text-sm text-gray-600">会員名カナ</label>
                                        ...
                                        <div class="relative">
                                            ...
                                            <label for="gender0" class="ml-2 mr-8">男性</label>
                                        ...
                                        <div class="p-2 w-full">
                                        <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">会員登録</button>
                                        </div>
