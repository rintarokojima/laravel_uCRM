            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <form @submit.prevent="getData">
                        ...
                        <button class="mt-4 mb-8 flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">分析する</button>
                    </form>
                    ...
                    <div v-show="data.data" class="lg:w-2/3 w-full mx-auto overflow-auto">
                                    <table class="mb-4 table-auto w-full text-left whitespace-no-wrap">
                                        ...
                                        <tr v-for="item in data.data" :key="item.id">
                                            <td class="border-t-2 px-4 py-3">{{ item.date }}</td>
                                            <td class="border-t-2 px-4 py-3">{{ item.total }}</td>
                                        </tr>
